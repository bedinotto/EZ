/* ez.java */
/* Generated By:JavaCC: Do not edit this line. ez.java */
package parser;
...
//                “{′′ ⟨BNF⟩ “}′′
  final public 
ListNode program() throws ParseException, ParseEOFException {
    trace_call("program");
    try {
...
{if ("" != null) return l;}
  ...
  private boolean jj_3R_vardecl_536_1_16()
 {
    ...
    if (jj_scan_token(24)) {
    jj_scanpos = xsp;
    if (jj_scan_token(50)) { if (!jj_rescan) trace_return("vardecl(LOOKAHEAD FAILED)"); return true; }
    }
    }
  ...
  private boolean jj_3_2()
 {
  ...
  public ezTokenManager token_source;
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x2001,0x2001,0x2000,0x10000,0x2000,0x4000,0x1080000,0x1080000,0x0,0x0,0x0,0x1080000,0x0,0x1080000,0x0,0x0,0x1080000,0x0,0x1080000,0x3ee1000,0x100000,0x0,0x8000,0x0,0x0,0x0,0x3ee1000,0x0,0x0,0x0,0x1080000,0x0,0x1080000,0xf8000000,0xf8000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x40000,0x40000,0x400,0x2000,0x400,0x40000,0x400,0x40000,0x400,0x2000,0x40000,0x400,0x40000,0x41100,0x78046,0x78046,0x0,0x40000,0x78046,0x40000,0x41100,0x4400,0x400,0x4000,0x40000,0x400,0x40000,0x1,0x1,0x6,0x6,0x38,0x38,0x6,0x6,0x78040,0x2000,0x78046,};
	}
  ...
  public ez(java.io.InputStream stream) {
	  this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public ez(java.io.InputStream stream, String encoding) {
	 try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
	 token_source = new ezTokenManager(jj_input_stream);
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
  ...
  /** Constructor. */
  public ez(java.io.Reader stream) {
 ...
 token_source = new ezTokenManager(jj_input_stream);
  ...
  /** Reinitialise. */
  public void ReInit(ezTokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
